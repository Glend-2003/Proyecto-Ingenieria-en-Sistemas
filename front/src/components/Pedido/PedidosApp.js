    ...
    <div className="pedidos-app">
          ...
          <table className="pedidos-table">
            ...
            <tbody>
              {filteredPedidos.map((pedido) => (
                <tr
                  key={pedido.idPedido}
                  className={pedido.estadoPedido ? "" : "inactive-row"}
                >
                  ...
                  <td>
                    <span
                      className={`active-status ${
                        pedido.estadoPedido ? "active" : "inactive"
                      }`}
                    >
            ...
            <div className="pedido-details-content">
              ...
              {!editMode ? (
                <>
                    ...
                    <div className="info-section">
                      ...
                      <p>
                        ...
                        {selectedPedido.montoTotalPedido
                          ? selectedPedido.montoTotalPedido.toLocaleString()
                          : "0"}
                      </p>
                      <p>
                        ...
                        <span
                          className={`active-status ${
                            selectedPedido.estadoPedido ? "active" : "inactive"
                          }`}
                        >
                      ...
                      <p>
                        ...
                        {selectedPedido.tipoPago
                          ? selectedPedido.tipoPago.descripcionTipoPago
                          : "N/A"}
                      </p>
                    </div>

                    {selectedPedido.carrito &&
                      selectedPedido.carrito.usuario && (
                        <div className="info-section">
                          <h3>Información del Cliente</h3>
                          <p>
                            <strong>Nombre:</strong>{" "}
                            {selectedPedido.carrito.usuario.nombreUsuario}{" "}
                            {selectedPedido.carrito.usuario.primerApellido}{" "}
                            {selectedPedido.carrito.usuario.segundoApellido}
                          </p>
                          <p>
                          ...
                          <p>
                            ...
                            {selectedPedido.carrito.usuario.correoUsuario}
                          </p>
                          <p>
                  ...
                  {selectedPedido.carrito &&
                    selectedPedido.carrito.producto && (
                      <div className="info-section">
                        <h3>Productos</h3>
                        <div className="product-item">
                          <div className="product-info">
                            <p>
                              <strong>Nombre:</strong>{" "}
                              {selectedPedido.carrito.producto.nombreProducto}
                            </p>
                            <p>
                              <strong>Cantidad:</strong>{" "}
                              {selectedPedido.carrito.cantidadCarrito}
                            </p>
                            <p>
                              <strong>Precio Unitario:</strong> ₡
                              {selectedPedido.carrito.producto
                                .montoPrecioProducto
                                ? selectedPedido.carrito.producto.montoPrecioProducto.toLocaleString()
                                : "0"}
                            </p>
                            <p>
                              <strong>Peso/Cantidad:</strong>{" "}
                              {selectedPedido.carrito.producto.cantidadProducto}{" "}
                              {selectedPedido.carrito.producto.tipoPesoProducto}
                            </p>
                          </div>
                    ...
                    <div className="status-buttons">
                      <button
                        className={`status-btn ${
                          selectedPedido.estadoEntregaPedido === "Pendiente"
                            ? "selected"
                            : ""
                        }`}
                        onClick={() =>
                          handleChangeEstadoEntrega(
                      ...
                      <button
                        className={`status-btn ${
                          selectedPedido.estadoEntregaPedido === "En Proceso"
                            ? "selected"
                            : ""
                        }`}
                        onClick={() =>
                      ...
                      <button
                        className={`status-btn ${
                          selectedPedido.estadoEntregaPedido === "Enviado"
                            ? "selected"
                            : ""
                        }`}
                        onClick={() =>
                      ...
                      <button
                        className={`status-btn ${
                          selectedPedido.estadoEntregaPedido === "Entregado"
                            ? "selected"
                            : ""
                        }`}
                        onClick={() =>
                      ...
                      <button
                        className={`status-btn cancel-btn ${
                          selectedPedido.estadoEntregaPedido === "Cancelado"
                            ? "selected"
                            : ""
                        }`}
                        onClick={() =>
      ...
      <div className="pedidos-summary">
        ...
        <div className="summary-item">
          ...
          <span className="summary-value">
            {
              pedidos.filter((p) => p.estadoEntregaPedido === "Pendiente")
                .length
            }
          </span>
        </div>
        <div className="summary-item">
          ...
          <span className="summary-value">
            {
              pedidos.filter((p) => p.estadoEntregaPedido === "En Proceso")
                .length
            }
          </span>
        </div>
        <div className="summary-item">
          ...
          <span className="summary-value">
            {
              pedidos.filter((p) => p.estadoEntregaPedido === "Entregado")
                .length
            }
          </span>
        </div>
