      ...
      <div className="content-container">
        ...
        <div className="main-content">
                        ...
                        <tbody>
                          {selectedPedido.carrito.productos.map((producto, index) => (
                            <tr key={index}>
                              ...
                              <td>₡{producto.montoPrecioProducto ? producto.montoPrecioProducto.toLocaleString() : '0'}</td>
                              <td>₡{(producto.cantidad * producto.montoPrecioProducto).toLocaleString()}</td>
                            </tr>
                          ))}
                        </tbody>
                      </table>
          ...
          <div className="graficos-section">
            <h2>Reporte de Ventas Canceladas</h2>
