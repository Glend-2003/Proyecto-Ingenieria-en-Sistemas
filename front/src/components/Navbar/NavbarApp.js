...
import ListaProductosApp from "../Catalogo/ListaProductosApp"
...
const NavbarApp = () => {
  ...
  const {handleShowSidebar, handleShowCart, idUsuario, cart, handleGlobalSearch, globalSearchTerm} = useAppContext();
