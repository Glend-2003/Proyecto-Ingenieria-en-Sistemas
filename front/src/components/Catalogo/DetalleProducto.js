...
import { useCart } from "../Carrito/ContextoCarrito.js"; // Importa el contexto del carrito para gestionar productos en el carrito
import "./DetalleProducto.css"; // Importa los estilos CSS específicos para esta página
