...
import { Card, Button, Spinner, Row, Col, Container, Navbar } from "react-bootstrap"; // Componentes de Bootstrap para estilos y estructura
//import { useCart } from "../Carrito/CarritoApp.js"; // Importa el contexto del carrito para gestionar productos en el carrito
import "../ContenidoProducto/DetalleProducto.css"; // Importa los estilos CSS específicos para esta página
